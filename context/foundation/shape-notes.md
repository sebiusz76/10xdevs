...
checkpoint:
  ...
  gray_areas_resolved:
    - topic: "pain category"
      decision: "workflow friction — manual flashcard creation interrupts the learning rhythm"
    - topic: "primary persona"
      decision: "self-taught / professional learner studying after hours from articles, docs, books"
    - topic: "core insight"
      decision: "existing tools (Anki, Quizlet) repeat well but still force manual card creation — that step kills adoption of spaced repetition"
    - topic: "access model"
      decision: "email + password accounts; flat user model — each user owns only their own cards"
  frs_drafted: 9
